...
I studied at the University of Manitoba, completing a B.Sc. Honours in Psychology in 2007 and a B.Sc. in Computer Science in 2013. My psychology work was in animal behavior and behavioral biology labs. My computer science work moved into Human-Computer Interaction research with Pourang Irani. That research produced publications at ACM APGV (2009) and IEEE PacificVis (2011).
...
- 2012-2019: independent consulting across web apps, prototypes, and internal tools
...
My current work is centered on a private control-plane stack and the public notes and experiments around it. The core internal repos are Mesh, Orchestrator, OCC, and Console. Around that, I keep public or semi-public work in `taylorsando.com`, `sandolab`, `hockeypedia`, `payment-ontology`, `community-platform`, and `voice-tools`.
...
- selected software experiments such as Hockeypedia and Sandolab
